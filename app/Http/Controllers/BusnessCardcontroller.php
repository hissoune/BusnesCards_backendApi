...
class BusnessCardcontroller extends Controller
{
    /**
   ...
   /**
    ...
    public function updateBusinessCard(Request $request, $id)
    {
        ...
        $businessCard = busnesCard::where('id', $id)->first();
     ...
     */
    public function show(busnesCard $businessCard)
    {
        //
    }
     ...
     */
    public function edit(busnesCard $businessCard)
    {
        //
    }
     ...
     */
    public function update(Request $request, busnesCard $businessCard)
    {
        //
    }
...
{
    $user = Auth::user();
    $businessCard = busnesCard::find($id);
